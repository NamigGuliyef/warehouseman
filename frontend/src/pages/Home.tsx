import { Download, MapPin, Calendar, Mail, Phone, Award, Briefcase, Code, User, Truck, Package, BarChart3, Clock } from "lucide-react";
...
const Home = () => {
  const workExperience = [
    {
      ...
      period: "2020-2024",
      description: "Anbar əməliyyatlarının idarə edilməsi, inventar nəzarəti və komanda rəhbərliyi",
      location: "Bakı"
    },
    {
      ...
      period: "2018-2020", 
      description: "Məhsul qəbulu, saxlanması və göndərilməsi proseslərinin həyata keçirilməsi",
      location: "Bakı"
    },
    {
      ...
      period: "2016-2018",
      description: "Daşıma proseslərinin planlaşdırılması və nəqliyyat marşrutlarının optimallaşdırılması",
      location: "Bakı"
    }
  ];
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[90vh] sm:min-h-screen py-10 sm:py-20">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6">
                ...
                <br />
                <span className="text-foreground">Quliyev</span>
              </h1>

              {/* Subtitle with typing effect */}
              <div className="mb-4 sm:mb-6">
                <p className="text-lg sm:text-xl md:text-2xl font-semibold text-secondary mb-2">
                  Anbar və Logistika Mütəxəssisi
                </p>
                <p className="text-sm sm:text-base lg:text-lg text-muted-foreground max-w-lg mx-auto lg:mx-0 leading-relaxed px-4 lg:px-0">
                  7+ il təcrübə ilə anbar proseslərini optimallaşdıran, 
                  müasir texnologiyalardan istifadə edərək effektivliyi artıran professional həllər təqdim edirəm
                </p>
              </div>

              {/* Action buttons */}
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start mb-8 sm:mb-12 px-4 lg:px-0">
                <Button size="lg" className="btn-industrial text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 group w-full sm:w-auto">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 px-4 lg:px-0">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center p-3 sm:p-4 rounded-lg bg-card/50 backdrop-blur-sm border border-border/50 hover:shadow-card transition-all duration-300">
            ...
            <div className="space-y-4 sm:space-y-6 order-1 lg:order-2">
              <div className="text-center lg:text-left mb-6 sm:mb-8">
                <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-2">Xidmətlərim</h3>
                <p className="text-sm sm:text-base text-muted-foreground">Professional anbar və logistika həlləri</p>
              </div>
                ...
                <Card key={index} className="card-3d group cursor-pointer">
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      ...
                      <div>
                        <h4 className="text-base sm:text-lg font-semibold text-foreground mb-2">{service.title}</h4>
              ...
              <Card className="bg-gradient-to-r from-primary to-secondary text-primary-foreground border-0 shadow-glow">
                <CardContent className="p-4 sm:p-6 text-center">
                  <h4 className="text-lg sm:text-xl font-bold mb-2">Layihəniz var?</h4>
                  <p className="mb-4 opacity-90 text-sm sm:text-base">Anbar və logistika məsələlərinizdə kömək edək</p>
                  <Button 
                    variant="secondary" 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4 sm:px-0">
              Real vaxt rejimində anbar əməliyyatları - nəqliyyat vasitələrinin gəlişi, 
              malların boşaldılması və rəflərə sistemli yığımı
            </p>
          </div>
          ...
          <div className="mt-8 sm:mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto">
            <Card className="card-3d border-l-4 border-l-blue-500">
              <CardContent className="p-4 sm:p-6 text-center">
                ...
                <h3 className="font-semibold text-base sm:text-lg mb-2">Nəqliyyat Qəbulu</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">
                  Müxtəlif ölçülü nəqliyyat vasitələrinin düzgün vaxtda və effektiv qəbulu
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="card-3d border-l-4 border-l-green-500">
              <CardContent className="p-4 sm:p-6 text-center">
                ...
                <h3 className="font-semibold text-base sm:text-lg mb-2">İşçi Koordinasiyası</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">
                  Təcrübəli işçi komandası ilə malların təhlükəsiz və sürətli boşaldılması
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="card-3d border-l-4 border-l-orange-500">
              <CardContent className="p-4 sm:p-6 text-center">
                ...
                <h3 className="font-semibold text-base sm:text-lg mb-2">Sistemli Saxlama</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">
                  Malların rəflərə düzgün yerləşdirilməsi və inventar idarəetməsi
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="mt-12 sm:mt-16 text-center">
            <Card className="inline-block bg-gradient-to-r from-primary to-secondary text-primary-foreground border-0 shadow-glow max-w-4xl mx-auto">
              <CardContent className="p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-bold mb-3">Anbar proseslərinizi optimallaşdırmaq istəyirsiniz?</h3>
                <p className="text-base sm:text-lg mb-6 opacity-90">
                  7+ il təcrübəm ilə anbardakı bütün prosesləri effektiv şəkildə idarə edirəm
                </p>
                <Button 
                  size="lg" 
                  variant="secondary" 
                  ...
                  <CardContent className="p-8">
                    <div className="space-y-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-primary mb-3">Professional Background</h3>
                          <p className="text-muted-foreground leading-relaxed">
                            Anbar və logistika sahəsində 7+ il təcrübəyə malik peşəkar mütəxəssisəm. 
                            Müxtəlif ölçülü şirkətlərdə anbar əməliyyatlarının idarə edilməsi, inventar nəzarəti 
                            və logistika proseslərinin optimallaşdırılması sahəsində geniş təcrübəm var.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-secondary mb-3">Texnoloji Fokus</h3>
                          <p className="text-muted-foreground leading-relaxed">
                            Texnologiyadan istifadə edərək anbar proseslərini avtomatlaşdırmaq və 
                            effektivliyi artırmaq mənim əsas maraqlarımdandır. Data analizi və 
                            müasir anbar idarəetməsi sistemləri ilə işləməkdə ixtisaslaşmışam.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-sm font-medium">Anbar İdarəetməsi</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-3 h-3 bg-secondary rounded-full"></div>
                        <span className="text-sm font-medium">Logistika Planlaşdırması</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-3 h-3 bg-accent rounded-full"></div>
                        <span className="text-sm font-medium">Data Analizi</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-gradient-to-br from-secondary/10 to-accent/10 border-secondary/20">
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span>Təcrübə</span>
                        <span className="font-bold">7+ il</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Layihələr</span>
      ...
      <section id="experience" className="py-20 bg-gradient-to-br from-accent/30 to-secondary/20 relative">
                          ...
                          <div className="relative z-10">
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                              ...
                              <div className="flex flex-col md:items-end gap-2 mt-4 md:mt-0">
                                <Badge variant="default" className="bg-gradient-to-r from-primary to-secondary text-primary-foreground border-0">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Professional anbar və logistika sahəsində istifadə etdiyim texnologiyalar və sistemlər
            </p>
          </div>
      ...
      <section id="certificates" className="py-20 bg-gradient-to-br from-secondary/10 via-accent/10 to-primary/10 relative">
        <div className="absolute inset-0 opacity-5">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-primary/10 text-primary px-4 py-2 rounded-full mb-6 border border-primary/20">
              ...
              <span className="font-semibold text-sm">Peşəkar sertifikatlar</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Peşəkar inkişafım üçün əldə etdiyim beynəlxalq sertifikatlar və lisenziyalar
            </p>
          </div>

          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            {certificates.map((cert, index) => (
              <Card key={index} className="group relative overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 bg-gradient-to-br from-card to-card/80 border-2 hover:border-primary/50">
      ...
      <section id="contact" className="py-10 sm:py-20 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-12 sm:mb-16 text-foreground">Əlaqə</h2>
          <div className="max-w-4xl mx-auto">
              ...
              <CardContent className="p-6 sm:p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">namiq@example.com</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      <div className="p-2 sm:p-3 bg-primary/10 rounded-lg">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg sm:text-xl font-semibold">Sosial şəbəkələr</h3>
                    <div className="flex flex-wrap gap-2 sm:gap-4">
                      {["LinkedIn", "WhatsApp", "Instagram"].map((social) => (
                        <Button key={social} variant="outline" size="sm" className="text-xs sm:text-sm">
                          {social}
                        </Button>
                      ))}
                    </div>
