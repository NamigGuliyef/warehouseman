...
const Dashboard = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    profBackground: "Təcrübəli anbar mütəxəssisi və logistika uzmanı",
    technologyFocus: "Müasir anbar idarəetməsi və logistika texnologiyaları",
    experienceYears: "" as string | undefined,
    managedProducts: "" as string | undefined,
    solvedLogistics: "" as string | undefined,
    efficiencyRate: "" as string | undefined
  });
  ...
  const handleProfileUpdate = (updatedProfile: {
    ...
    setProfile({
      ...
      profBackground: updatedProfile.profBackground,
      technologyFocus: updatedProfile.technologyFocus,
      experienceYears: updatedProfile.experienceYears || "",
      managedProducts: updatedProfile.managedProducts || "",
      solvedLogistics: updatedProfile.solvedLogistics || "",
      efficiencyRate: updatedProfile.efficiencyRate || ""
    });
  };
