...
const VacancyManagement = () => {
  ...
  const [vacancyForm, setVacancyForm] = useState({
    ...
    schedule: "Tam ştat", priority: "Adi"
  });
  ...
  const handleEditVacancy = (vacancy) => {
    ...
    setVacancyForm({
      ...
      schedule: vacancy.schedule, priority: vacancy.priority
    });
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground">Vakansiya İdarəetməsi</h1>
        <p className="text-muted-foreground mt-2">Vakansiyalarınızı idarə edin</p>
      </div>
